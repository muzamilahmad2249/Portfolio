...
const Contact = () => {
  return (
    <div className="bg-white text-black dark:bg-black dark:text-white py-20 transition-colors duration-500" id="contact">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="flex-1 mb-10 md:mb-0">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              I'm open to discussing web development projects or new opportunities.
            </p>

            <div className="mb-4 mt-8">
              <FaEnvelope className="inline-block text-green-400 mr-2" />
              <a href="mailto:youremail@example.com" className="hover:underline">
                muzamilahmad4129@gmail.com
              </a>
            </div>
            <div className="mb-4">
              <FaPhone className="inline-block text-green-400 mr-2" />
              <span>+923495275601</span>
            </div>
            <div className="mb-4">
              <FaMapMarkedAlt className="inline-block text-green-400 mr-2" />
              <span>Street 4, Lahore, Punjab, Pakistan</span>
            </div>
          </div>
